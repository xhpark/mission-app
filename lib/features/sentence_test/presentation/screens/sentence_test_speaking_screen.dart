...
class _SentenceTestSpeakingScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return InteractiveLearningScreen(
      ...
      primaryButtonLabel: l10n?.sentenceTestSpeakingPrimaryButton ?? 'Finish Test',
