...
class SessionSummaryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final subtitle = session == null
        ...
        : l10n.sessionSummarySubtitleWithMode(
            _modeLabel(session.mode, l10n),
          );
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          AppHeroHeader(
            title: l10n.sessionSummaryHeroTitle,
            subtitle: subtitle,
          ...
          AppStatusBanner(
            ...
            message: l10n.sessionSummaryCoachNote,
          ),
          const SizedBox(height: 16),
          AppSectionCard(
            title: l10n.sessionSummaryNextRecommendationTitle,
            description: l10n.sessionSummaryNextRecommendationDescription,
            icon: Icons.trending_up_outlined,
            child: Text(
              l10n.sessionSummaryNextRecommendationBody,
              style: Theme.of(context).textTheme.bodyLarge,
            ),
          ),
        ],
      ...
      bottomNavigationBar: AppBottomActionBar(
        secondaryLabel: l10n.sessionSummarySecondaryToSelect,
        onSecondaryPressed: () => context.go('/select'),
        primaryLabel: l10n.sessionSummaryPrimaryToReportPreview,
        onPrimaryPressed: () {
          ref.read(reportRequirementProvider.notifier).requireReport();
          context.go('/report-preview');
        },
      ),
    );
  }
